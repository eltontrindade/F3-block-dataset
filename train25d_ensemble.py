...
from mylib.loss import soft_dice_loss, dice_loss_perclass,soft_cross_entropy_loss
...
def train(model, train_set, test_set, save, valid_set, n_epochs,canal):
    ...
    # Data loaders
    train_loader = DataLoader(test_set, batch_size=cfg.test_batch_size, shuffle=True,
